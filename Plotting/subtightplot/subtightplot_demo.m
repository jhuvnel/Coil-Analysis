...
if ~make_it_tight,  clear subplot;  end
          %(row, column, position, [ ], [Norm distance from bottom Nrom distance from top],[Norm distance from left 
%subtightplot (m, n, p, [0.01 0.05], [0.1 0.01], [0.1 0.01])
%% Upper and Lower Subplots with Titles
income = [3.2,4.1,5.0,5.6];
outgo = [2.5,4.0,3.35,4.9];
subtightplot(2,1,1); plot(income)
title('Income')
